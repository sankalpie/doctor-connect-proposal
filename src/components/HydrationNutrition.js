    ...
    return (
        <div>
            ...
            <div id="mainContent" className='mainGoal' style={{ backgroundColor: 'white', }}>
                ...
                <div id="wrapper">
                    <div id="tabsContainer" className='tabsContainer'>
                        <div id="appopintmentTabs" className='appointmentTabs'>
                            ...
                            <Link to='/HydrationNutrition' className="appointmentButtons insightsInfo" style={{backgroundColor:'white',borderTop:'2px solid orange'}}>Hydration & Nutrition Logs</Link>
                ...
                <div id="subContent">
                    <div id="leftContent">
                        <HighchartsReact highcharts={Highcharts} options={options_HYDRATION} />
                    </div>
                    <div id="rightContent">
