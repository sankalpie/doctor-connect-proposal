    ...
    return (
        <div>
            ...
            <div id="mainContent" className='mainGoal' style={{ backgroundColor: 'white', }}>
                ...
                <div id="wrapper">
                    <div id="tabsContainer" className='tabsContainer'>
                        <div id="appopintmentTabs" className='appointmentTabs'>
                            ...
                            <Link to='/ECG' className="appointmentButtons lastAppointmentButton healthTestsInfo" style={{backgroundColor:'white',borderTop:'2px solid orange'}}>ECG</Link>
                        </div>
                    </div>
                </div>
                ...
                <div id="subContent">
                    <div id="leftContent">
                        <HighchartsReact highcharts={Highcharts} options={options_ACTIVITY_LOG} />
                    </div>
                    <div id="rightContent">
