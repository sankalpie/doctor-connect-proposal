    ...
    return (
        <div>
            ...
            <div id="mainContent" className='mainGoal' style={{ backgroundColor: 'white', }}>
                ...
                <div id="wrapper">
                    <div id="tabsContainer" className='tabsContainer'>
                        <div id="appopintmentTabs" className='appointmentTabs'>
                            ...
                            <Link to='/SPO2' className="appointmentButtons goalsNHabitsInfo" style={{backgroundColor:'white',borderTop:'2px solid orange'}}>SPO2</Link>
                ...
                <div id="subContent">
                    <div id="leftContent">
                        <HighchartsReact highcharts={Highcharts} options={options_SPO2} />
                    </div>
                    <div id="rightContent">
