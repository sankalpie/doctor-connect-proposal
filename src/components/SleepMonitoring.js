    ...
    return (
        <div>
            ...
            <div id="mainContent" className='mainGoal' style={{ backgroundColor: 'white', }}>
                ...
                <div id="wrapper">
                    <div id="tabsContainer" className='tabsContainer'>
                        <div id="appopintmentTabs" className='appointmentTabs'>
                            ...
                            <Link to='/SleepMonitoring' className="appointmentButtons coachNotesInfo" style={{backgroundColor:'white',borderTop:'2px solid orange'}}>Sleep Monitoring</Link>
                ...
                <div id="subContent">
                    <div id="leftContent">
                        <HighchartsReact highcharts={Highcharts} options={options_SLEEP} />
                    </div>
                    <div id="rightContent">
